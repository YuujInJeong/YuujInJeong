...
| 분야 | 세부 관심사 | 설명 |
|------|-------------|------|
| 🤖 **AI/ML Engineering** | Large Language Models, Graph Neural Networks | 확장 가능한 AI 서비스 구축 및 연구 |
| ☁️ **Cloud Computing** | AWS, Cloud Native Development | 프로덕션 수준의 배포 기술 향상 |
| ♿ **Accessibility Technology** | 시각장애인을 위한 앱 접근성 | 포용적 기술 개발 |
...
### 🎓 KHUDA (경희대학교 데이터/인공지능 동아리)

| 기수 | 연도 | 트랙/역할 | 활동 내용 |
|------|------|-----------|-----------|
| 8기 | 2025 | 대외협력부장, NLP 트랙장 | 자연어처리 트랙 운영 및 대외협력 담당 |
| 7기 | 2024 | 데이터 시각화 스터디장, 회장 | 데이터 시각화 스터디 운영 및 동아리 총괄 |
| 6기 | 2024 | Deploy Session, 회장 | 배포 세션 운영 및 동아리 총괄 |
| 5기 | 2023 | CV트랙, 홍보부장, 데이터비지니스 트랙장 | 컴퓨터비전 트랙, 홍보, 데이터비지니스 트랙 운영 |
| 4기 | 2023 | 금융트랙, 홍보부장 | 금융트랙 수강 및 홍보 담당 |
| 3기 | 2022 | 금융트랙 수강 | 금융트랙 참여 |

### 💻 DADINGCODING (대학생연합코딩교육봉사동아리)

| 기수 | 연도 | 역할 | 활동 내용 |
|------|------|------|-----------|
| 8기 | 2025 | 운영진 | 서울/경기권 대학생연합코딩교육봉사동아리 운영 |
| 7기 | 2024 | 회장 | 서울/경기권 대학생연합코딩교육봉사동아리 총괄 |
| 5,6기 | 2023 | 회장 | 서울/경기권 대학생연합코딩교육봉사동아리 총괄 |
| 2,3,4기 | 2022 | 공동회장 | 서울/경기권 대학생연합코딩교육봉사동아리 공동운영 |
| 1기 | 2021 | 공동회장 | 서울/경기권 대학생연합코딩교육봉사동아리 창립 및 공동운영 |

### 🌟 기타 활동

| 연도 | 조직/프로그램 | 역할 | 활동 내용 |
|------|---------------|------|-----------|
| 2025 | Perplexity Campus | Strategist | 캠퍼스 전략가 활동 |
| 2025 | 이데일리, APEC | 서포터즈 | 국제 통상회의 서포터즈 |
| 2024 | 서울 동북고등학교 | CA 강사 | 고교 동아리 알고리즘 2반 강의 |
| 2024 | 경기대전환포럼 | 기획진 | AI 클래스룸 기획 및 진행 |
...
- [Python GUI를 실행파일로 만들어본 후기](https://velog.io/@yujin_jeong/Python-GUI%EB%A5%BC-%EC%8B%A4%ED%96%89%ED%8C%8C%EC%9D%BC%EB%A1%9C-%EB%A7%8C%EB%93%9C%EC%96%B4%EB%B3%B8-%ED%9B%84%EA%B8%B0)
...
### About Me
I'm a **Pelican Mindset Developer** 🦈 who believes in "Just Do It First!" - diving into challenges with enthusiasm and learning through action.

### 🎯 Current Focus
- **Cloud Native Development**: Improving production-level deployment skills
- **AI/ML Engineering**: Building scalable AI services with research experience
- **Open Source**: Contributing to meaningful projects
- **Research**: Working as external researcher in Materials Science & IAI Lab

### 🛠️ Tech Stack
**Strong**: Python, React, Flutter, AI/ML  
**Learning**: AWS, TypeScript, System Architecture

### 👀 Areas of Interest
- 💻 **AI/ML Engineering**: Large Language Models, Graph Neural Networks
- ☁️ **Cloud Computing**: AWS, Cloud Native Development
- 🖥️ **System Architecture**: Microservices, Distributed Systems
- ♿ **Accessibility Technology**: Inclusive app development for visually impaired users
- 📊 **Data Analysis**: Customer behavior analysis, insight extraction

### 🤝 Let's Connect
Open to collaborations, hackathons, and meaningful tech discussions!

*For detailed experience and projects, please refer to the Korean version above.*